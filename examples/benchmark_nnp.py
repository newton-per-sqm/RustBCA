...
for ion in [hydrogen, deuterium, tritium]:
    ...
    r_rustbca = [
        reflection_coefficient(ion, beryllium, energy, 0.0, 10000)[0]
    ...
    plt.plot(
        energies,
        r_thomas,
        label=f"{ion['symbol']} on Be Thomas",
        linestyle="--",
...
for ion in [hydrogen, deuterium, tritium]:
    energies = np.logspace(1, 2, 25)
    y_rustbca = [
        sputtering_yield(ion, beryllium, energy, 0.0, 100000) for energy in energies
    ]
